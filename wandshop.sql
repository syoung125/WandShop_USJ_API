...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2020 at 06:06 PM
...
('laura1205@konkuk.ac.kr', '4a7d1ed414474e4033ac29ccb8653d9b', 'Laura', '3e5efea383c0356af132', 0);
...
(335, 'Harry Potter Wand', 22, 2, 3, 5, 6, 15, 'https://vignette.wikia.nocookie.net/harrypotter/images/9/93/Rowan.png/revision/latest?cb=20120718010524'),
(552, 'Ron Weasley Wand', 22, 1, 1, 3, 10, 3, 'https://images-na.ssl-images-amazon.com/images/I/514dFlW6psL._UL1400_.jpg'),
...
(717, 'Hermione Granger Illuminating Wand', 17, 1, 1, 2, 16, 49, 'https://d8mkdcmng3.imgix.net/cefe/collectables-and-hobbies-props-and-replicas-harry-potter-the-wand-of-ginny-weasley.jpg?auto=format&bg=0FFF&fit=fill&h=600&q=100&w=600&s=4da5078c6dadfdad5c52b5a329c66ab0'),
(821, 'Snape Wand', 29, 4, 2, 5, 12, 37, 'https://cdn11.bigcommerce.com/s-z5x6hb/images/stencil/1280x1280/products/16274/21135/09dbcc0b-de33-47b5-94da-ff5d7fb2c20d__24350.1542143436.jpg?c=2&imbypass=on?imbypass=on'),
...
ALTER TABLE `purchase`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_p_order_id` (`order_id`),
